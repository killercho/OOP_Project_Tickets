...
main: main.o ./String/String.o ./Date/Date.o ./Room/Room.o ./Ticket/Ticket.o ./Show/Show.o ./Vector/Vector.o
	g++ -o main main.o ./String/String.o ./Date/Date.o ./Room/Room.o ./Ticket/Ticket.o ./Show/Show.o ./Vector/Vector.o

# Add header files used in main:
main.o: main.cpp ./String/String.h ./Date/Date.h ./Room/Room.h ./Ticket/Ticket.h ./Show/Show.h ./Vector/Vector.h
	g++ -c main.cpp
